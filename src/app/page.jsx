    ...
    <div>
      ...
      <div id="about" className="mt-5 md:mt-3">
        ...
        <Section
          ...
          customClasses="p-2 m-5 h-[600px] md:h-[550px] lg:space-x-10 lg:h-[400px] lg:gap-[5px] 2xl:gap-[10px] border-black border-4 rounded-lg"
        ...
        <Section
          ...
          backgroundColor="bg-green-600 text-white"
          customClasses="p-2 h-[400px] md:h-[300px] lg:space-x-10 lg:h-[600px]"
        ...
        <Section
          ...
          reverse
          customClasses="p-2 h-[500px] md:h-[300px] lg:space-x-10 lg:h-[300px]"
